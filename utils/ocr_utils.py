...
class OCR:
    ...
    """
    prompt: str = ("Below is the image of one page of a document, as well as some raw textual content that was previously "
    ...
    def __init__(self, model_name: str = "NAMAA-Space/Qari-OCR-0.1-VL-2B-Instruct", max_tokens: int = 2000):
        """
